...
Public Class frmLecturerRequest
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        If cbClassType.SelectedIndex = -1 Or cbDay.SelectedIndex = -1 Or cbTime.SelectedIndex = -1 Or txtDescription.Text = "" Then
            ...
            MsgBox("Please make sure that all of the fields are filled in.", vbOKOnly, "Empty Field(s)")
        Else
            ...
            If inc <> 0 Then
                ...
                dsNewRow.Item("User_ID") = txtLecturerID.Text
    ...
    Private Sub frmLecturerRequest_VisibleChanged(sender As Object, e As EventArgs) Handles Me.VisibleChanged
        Me.CenterToScreen()
        txtLecturerID.Text = frmLoginPage.LecturerID    'the lecturer ID will be automatically filled in
        cbClassType.SelectedIndex = -1
        cbDay.SelectedIndex = -1
        cbTime.SelectedIndex = -1
        txtDescription.Clear()
    ...
    Private Sub frmLecturerRequest_Load(sender As Object, e As EventArgs) Handles MyBase.Load
