...
Public Class frmStudentVT
    ...
    Private Sub frmStudentVT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSearch1_Click(sender As Object, e As EventArgs) Handles btnSearch1.Click
        ...
        If IntakeCodeFound = True Then
            ...
            DGVStudentVT.DataSource = view      'DGV stands for Data Grid View
            'modification
            DGVStudentVT.Columns(0).HeaderText = "Day"
            DGVStudentVT.Columns(1).HeaderText = "Time"
            DGVStudentVT.Columns(2).HeaderText = "Classroom Name"
            DGVStudentVT.Columns(3).HeaderText = "Module Name"
            DGVStudentVT.Columns(4).HeaderText = "Lecturer Assigned"
            DGVStudentVT.Columns(0).Width = 70
            DGVStudentVT.Columns(1).Width = 70
            DGVStudentVT.Columns(2).Width = 70
            DGVStudentVT.Columns(3).Width = 220
            DGVStudentVT.Columns(4).Width = 100
        ...
        ElseIf cbIntakeCode.SelectedIndex = -1 Then
            ...
            cbLecturerName.SelectedIndex = -1
            cbIntakeCode.Select()
            DGVStudentVT.DataSource = Nothing
    ...
    Private Sub btnSearch2_Click(sender As Object, e As EventArgs) Handles btnSearch2.Click
        ...
        If LecturerNameFound = True Then
            ...
            Dim view As New DataView(tables(0))
            source1.DataSource = view
            DGVStudentVT.DataSource = view
            'modification
            DGVStudentVT.Columns(0).HeaderText = "Day"
            DGVStudentVT.Columns(1).HeaderText = "Time"
            DGVStudentVT.Columns(2).HeaderText = "Classroom Name"
            DGVStudentVT.Columns(3).HeaderText = "Module Name"
            DGVStudentVT.Columns(4).HeaderText = "Intake Code"
            DGVStudentVT.Columns(5).HeaderText = "Lecturer Name"
            DGVStudentVT.Columns(0).Width = 70
            DGVStudentVT.Columns(1).Width = 70
            DGVStudentVT.Columns(2).Width = 70
            DGVStudentVT.Columns(3).Width = 220
            DGVStudentVT.Columns(4).Width = 100
            DGVStudentVT.Columns(5).Width = 150
    ...
    Private Sub frmStudentVT_VisibleChanged(sender As Object, e As EventArgs) Handles Me.VisibleChanged
        Me.CenterToScreen()
        cbIntakeCode.SelectedIndex = -1
        cbLecturerName.SelectedIndex = -1
        cbIntakeCode.Select()
